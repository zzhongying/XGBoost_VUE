...
!function (t, n) {
    ...
    H.prototype = I.prototype = {
        constructor: H, on: function (t, n) {
            ...
            if (!(arguments.length < 2)) {
                ...
                for (; ++o < a;) if (e = (t = i[o]).type) r[e] = X(r[e], t.name, n); else if (null == n) for (e in r) r[e] = X(r[e], t.name, null);
                return this
            }
            for (; ++o < a;) if ((e = (t = i[o]).type) && (e = V(r[e], t.name))) return e
        }, copy: function () {
            var t = {}, n = this._;
    ...
    var je = He(fe), Ve = He(le);

    function Xe(t) {
        return function (n, e) {
            var r = t((n = Vn(n)).h, (e = Vn(e)).h), i = le(n.c, e.c), o = le(n.l, e.l), a = le(n.opacity, e.opacity);
            return function (t) {
    ...
    var Ii = Math.cos, Hi = Math.sin, ji = Math.PI, Vi = ji / 2, Xi = 2 * ji, Gi = Math.max;
    ...
    var Yo = Fo(","), Io = Yo.parse, Ho = Yo.parseRows, jo = Yo.format, Vo = Yo.formatBody, Xo = Yo.formatRows,
        ...
        function l(t) {
            ...
            function M(t) {
                ...
                if ("c" === _) M = x(t) + M, t = ""; else {
                    ...
                    }(t)), N && 0 == +t && (N = !1), h = (N ? "(" === l ? l : f : "-" === l || "(" === l ? "" : l) + h, M = ("s" === _ ? Va[8 + La / 3] : "") + M + (N && "(" === l ? ")" : ""), w) for (i = -1, o = t.length; ++i < o;) if (48 > (c = t.charCodeAt(i)) || c > 57) {
    ...
    function Tc(t, n) {
        var e = ju([t * cu, n * cu]);
        if (rc) {
            var r = Xu(rc, e), i = Xu([r[1], -r[0], 0], r);
            Wu(i), i = Hu(i);
    ...
    function pf(t) {
        ...
        function a(t, e, r) {
            var i = [1, 0, 0], o = Xu(ju(t), ju(e)), a = Vu(o, o), u = o[0], c = a - u * u;
            if (!c) return !r && t;
            var f = n * a / c, s = -n * u / c, l = Xu(i, o), h = $u(i, f);
            Gu(h, $u(o, s));
            var d = l, p = Vu(h, d), v = Vu(d, d), g = p * p - v * (Vu(h, h) - 1);
            if (!(g < 0)) {
    ...
    function Zs(t, n, e, r) {
        var i = hu(r), o = yu(r), a = i * t, u = o * t, c = i / t, f = o / t, s = (o * e - i * n) / t,
            l = (o * n + i * e) / t;
    ...
    function El(t, n) {
        var e, r, i, o, a, u = new Rl(t), c = +t.value && (u.value = t.value), f = [u];
        for (null == n && (n = Cl); e = f.pop();) if (c && (e.value = +e.data.value), (i = n(e.data)) && (a = i.length)) for (e.children = new Array(a), o = a - 1; o >= 0; --o) f.push(r = e.children[o] = new Rl(i[o])), r.parent = e, r.depth = e.depth + 1;
    ...
    function ql(t) {
        for (var n, e, r = 0, i = (t = function (t) {
            ...
            return t
        }(Dl.call(t))).length, o = []; r < i;) n = t[r], e && Ol(e, n) ? ++r : (e = Fl(o = Ll(o, n)), r = 0);
        return e
    }
    ...
    function Ll(t, n) {
        var e, r;
        if (Bl(n, t)) return [n];
        for (e = 0; e < t.length; ++e) if (Ul(n, t[e]) && Bl(Yl(t[e], n), t)) return [t[e], n];
        for (e = 0; e < t.length - 1; ++e) for (r = e + 1; r < t.length; ++r) if (Ul(Yl(t[e], t[r]), n) && Ul(Yl(t[e], n), t[r]) && Ul(Yl(t[r], n), t[e]) && Bl(Il(t[e], t[r], n), t)) return [t[e], t[r], n];
        throw new Error
    }
    ...
    function Bl(t, n) {
        for (var e = 0; e < n.length; ++e) if (!Ol(t, n[e])) return !1;
        return !0
    }
    ...
    function Gl(t) {
        ...
        t:for (u = 3; u < i; ++u) {
            ...
            for (r.previous = n, r.next = e, n.next = e.previous = e = r, o = Vl(n); (r = r.next) !== e;) (a = Vl(r)) < o && (n = r, o = a);
            e = n.next
        }
        for (n = [e._], r = e; (r = r.next) !== e;) n.push(r._);
        for (r = ql(n), u = 0; u < i; ++u) (n = t[u]).x -= r.x, n.y -= r.y;
        return r.r
    }
    ...
    function th(t, n) {
        return function (e) {
            if (r = e.children) {
                ...
                if (o = Gl(r), u) for (i = 0; i < a; ++i) r[i].r -= u;
                e.r = o + u
            }
        }
    }
    ...
    function wh(t) {
        for (var n = t.length, e = [0, 1], r = 2, i = 2; i < n; ++i) {
            for (; r > 1 && mh(t[e[r - 2]], t[e[r - 1]], t[i]) <= 0;) --r;
            e[r++] = i
        }
        return e.slice(0, r)
    }
    ...
    var zh = Array.prototype, Rh = zh.map, Dh = zh.slice, qh = {name: "implicit"};
    ...
    function jh(t, n, e) {
        ...
        for (t[r] < t[0] && (t = t.slice().reverse(), n = n.slice().reverse()); ++u < r;) o[u] = Yh(t[u], t[u + 1]), a[u] = e(n[u], n[u + 1]);
        return function (n) {
            var e = i(t, n, 1, r) - 1;
            return a[e](o[e](n))
        }
    ...
    function Xh() {
        var t, n, e, r, i, o, a = Bh, u = Bh, c = Te, f = Fh;
    ...
    function rd(n) {
        var e, r, i = n(Qh, Kh), o = i.domain, a = 10;
    ...
    var gd = vd.range, yd = 6e4, _d = 6048e5, bd = pd(function (t) {
    ...
    var kd = Sd(0), Ed = Sd(1), Cd = Sd(2), Pd = Sd(3), zd = Sd(4), Rd = Sd(5), Dd = Sd(6), qd = kd.range,
        Ld = Ed.range, Ud = Cd.range, Od = Pd.range, Bd = zd.range, Fd = Rd.range, Yd = Dd.range, Id = pd(function (t) {
    ...
    var Vd = jd.range, Xd = pd(function (t) {
        t.setUTCSeconds(0, 0)
    }, function (t, n) {
        t.setTime(+t + n * yd)
    }, function (t, n) {
    ...
    var Jd = Kd(0), tp = Kd(1), np = Kd(2), ep = Kd(3), rp = Kd(4), ip = Kd(5), op = Kd(6), ap = Jd.range,
        up = tp.range, cp = np.range, fp = ep.range, sp = rp.range, lp = ip.range, hp = op.range, dp = pd(function (t) {
    ...
    function mp(t) {
        var n = t.dateTime, e = t.date, r = t.time, i = t.periods, o = t.days, a = t.shortDays, u = t.months,
            c = t.shortMonths, f = kp(i), s = Ep(i), l = kp(o), h = Ep(o), d = kp(a), p = Ep(a), v = kp(u), g = Ep(u),
            y = kp(c), _ = Ep(c), b = {
                a: function (t) {
                    return a[t.getDay()]
                }, A: function (t) {
                    ...
                    return u[t.getMonth()]
                }, c: null, d: Zp, e: Zp, f: nv, H: Qp, I: Kp, j: Jp, L: tv, m: ev, M: rv, p: function (t) {
                    return i[+(t.getHours() >= 12)]
                }, q: function (t) {
                    return 1 + ~~(t.getMonth() / 3)
                }, Q: Pv, s: zv, S: iv, u: ov, U: av, V: uv, w: cv, W: fv, x: null, X: null, y: sv, Y: lv, Z: hv, "%": Cv
            }, m = {
                a: function (t) {
                ...
                }, c: null, d: dv, e: dv, f: _v, H: pv, I: vv, j: gv, L: yv, m: bv, M: mv, p: function (t) {
                    return i[+(t.getUTCHours() >= 12)]
                }, q: function (t) {
                    return 1 + ~~(t.getUTCMonth() / 3)
                }, Q: Pv, s: zv, S: xv, u: wv, U: Mv, V: Nv, w: Tv, W: Av, x: null, X: null, y: Sv, Y: kv, Z: Ev, "%": Cv
            }, x = {
                a: function (t, n, e) {
                    ...
                    return N(t, n, e, r)
                }, d: Fp, e: Fp, f: Xp, H: Ip, I: Ip, j: Yp, L: Vp, m: Bp, M: Hp, p: function (t, n, e) {
                    var r = f.exec(n.slice(e));
                    return r ? (t.p = s[r[0].toLowerCase()], e + r[0].length) : -1
                }, q: Op, Q: $p, s: Wp, S: jp, u: Pp, U: zp, V: Rp, w: Cp, W: Dp, x: function (t, n, r) {
                    return N(t, e, n, r)
                }, X: function (t, n, e) {
                    return N(t, r, n, e)
                }, y: Lp, Y: qp, Z: Up, "%": Gp
        ...
        function w(t, n) {
            return function (e) {
                ...
                for (e instanceof Date || (e = new Date(+e)); ++u < f;) 37 === t.charCodeAt(u) && (a.push(t.slice(c, u)), null != (i = wp[r = t.charAt(++u)]) ? r = t.charAt(++u) : i = "e" === r ? " " : "0", (o = n[r]) && (r = o(e, i)), a.push(r), c = u + 1);
    ...
    var xp, wp = {"-": "", _: " ", 0: "0"}, Mp = /^\s*\d+/, Np = /^%/, Tp = /[\\^$*+?|[\]().{}]/g;
    ...
    var qv = +new Date("2000-01-01T00:00:00.000Z") ? function (t) {
        ...
        } : t.utcParse("%Y-%m-%dT%H:%M:%S.%LZ"), Lv = 1e3, Uv = 60 * Lv, Ov = 60 * Uv, Bv = 24 * Ov, Fv = 7 * Bv,
        Yv = 30 * Bv, Iv = 365 * Bv;
    ...
    function Vv(t, n, r, i, o, a, u, c, f) {
        var s = Gh(Fh, Fh), l = s.invert, h = s.domain, d = f(".%L"), p = f(":%S"), v = f("%I:%M"), g = f("%I %p"),
    ...
    function Xv() {
        var t, n, e, r, i, o = 0, a = 1, u = Fh, c = !1;
    ...
    function Wv() {
        var t, n, e, r, i, o, a, u = 0, c = .5, f = 1, s = Fh, l = !1;
    ...
    var fg = new Array(3).concat("d8b365f5f5f55ab4ac", "a6611adfc27d80cdc1018571", "a6611adfc27df5f5f580cdc1018571", "8c510ad8b365f6e8c3c7eae55ab4ac01665e", "8c510ad8b365f6e8c3f5f5f5c7eae55ab4ac01665e", "8c510abf812ddfc27df6e8c3c7eae580cdc135978f01665e", "8c510abf812ddfc27df6e8c3f5f5f5c7eae580cdc135978f01665e", "5430058c510abf812ddfc27df6e8c3c7eae580cdc135978f01665e003c30", "5430058c510abf812ddfc27df6e8c3f5f5f5c7eae580cdc135978f01665e003c30").map(Qv),
        ...
        cy = cg(uy);
    var fy = Qe(ee(300, .5, 0), ee(-240, .5, 1)), sy = Qe(ee(-100, .75, .35), ee(80, 1.5, .8)),
        ly = Qe(ee(260, .75, .35), ee(80, 1.5, .8)), hy = ee();
    var dy = _n(), py = Math.PI / 3, vy = 2 * Math.PI / 3;
    ...
    var wy = Math.abs, My = Math.atan2, Ny = Math.cos, Ty = Math.max, Ay = Math.min, Sy = Math.sin, ky = Math.sqrt,
        Ey = 1e-12, Cy = Math.PI, Py = Cy / 2, zy = 2 * Cy;
    ...
    function By(t, n, e, r, i, o, a) {
        var u = t - e, c = n - r, f = (a ? o : -o) / ky(u * u + c * c), s = f * c, l = -f * u, h = t + s, d = n + l,
            p = e + s, v = r + l, g = (h + p) / 2, y = (d + v) / 2, _ = p - h, b = v - d, m = _ * _ + b * b, x = i - o,
            w = h * v - p * d, M = (b < 0 ? -1 : 1) * ky(Ty(0, x * x * m - w * w)), N = (w * b - _ * M) / m,
    ...
    function jy() {
        var t = Iy, n = Hy, e = xy(!0), r = null, i = Yy, o = null;
    ...
    function Vy() {
        var t = Iy, n = null, e = xy(0), r = Hy, i = xy(!0), o = null, a = Yy, u = null;
    ...
    function Jy() {
        var t = Vy().curve($y), n = t.curve, e = t.lineX0, r = t.lineX1, i = t.lineY0, o = t.lineY1;
    ...
    function i_(t) {
        var n = e_, e = r_, r = Iy, i = Hy, o = null;

        function a() {
            var a, u = n_.call(arguments), c = n.apply(this, u), f = e.apply(this, u);
    ...
    function u_(t, n, e, r, i) {
        var o = t_(n, e), a = t_(n, e = (e + i) / 2), u = t_(r, e), c = t_(r, i);
    ...
    }, s_ = Math.sqrt(1 / 3), l_ = 2 * s_, h_ = {
        draw: function (t, n) {
            var e = Math.sqrt(n / l_), r = e * s_;
            t.moveTo(0, -e), t.lineTo(r, 0), t.lineTo(0, e), t.lineTo(-r, 0), t.closePath()
        }
    }, d_ = Math.sin(Cy / 10) / Math.sin(7 * Cy / 10), p_ = Math.sin(zy / 10) * d_, v_ = -Math.cos(zy / 10) * d_, g_ = {
        draw: function (t, n) {
            var e = Math.sqrt(.8908130915292852 * n), r = p_ * e, i = v_ * e;
            t.moveTo(0, -e), t.lineTo(r, i);
            for (var o = 1; o < 5; ++o) {
                var a = zy * o / 5, u = Math.cos(a), c = Math.sin(a);
    ...
    }, m_ = Math.sqrt(3) / 2, x_ = 1 / Math.sqrt(12), w_ = 3 * (x_ / 2 + 1), M_ = {
        draw: function (t, n) {
            var e = Math.sqrt(n / w_), r = e / 2, i = e * x_, o = r, a = e * x_ + e, u = -o, c = a;
    ...
    S_.prototype = {
        ...
        areaStart: T_, areaEnd: T_, lineStart: function () {
    ...
    X_.prototype = {
        ...
        areaStart: function () {
            ...
            if (e) if (this._line ? this._context.lineTo(t[0], n[0]) : this._context.moveTo(t[0], n[0]), 2 === e) this._context.lineTo(t[1], n[1]); else for (var r = nb(t), i = nb(n), o = 0, a = 1; a < e; ++o, ++a) this._context.bezierCurveTo(r[0][o], i[0][o], r[1][o], i[1][o], t[a], n[a]);
        ...
        constructor: db, insert: function (t, n) {
            var e, r, i;
            if (t) {
            ...
            for (n.L = n.R = null, n.U = e, n.C = !0, t = n; e && e.C;) e === (r = e.U).L ? (i = r.R) && i.C ? (e.C = i.C = !1, r.C = !0, t = r) : (t === e.R && (vb(this, e), e = (t = e).U), e.C = !1, r.C = !0, gb(this, r)) : (i = r.L) && i.C ? (e.C = i.C = !1, r.C = !0, t = r) : (t === e.L && (gb(this, e), e = (t = e).U), e.C = !1, r.C = !0, vb(this, r)), e = t.U;
            this._.C = !1
        }, remove: function (t) {
        ...
        if (n && e) {
            ...
            if (r !== o) {
                ...
                if (!(h >= -jb)) {
                    ...
                    for (var _ = null, b = Yb._; b;) if (y.y < b.y || y.y === b.y && y.x <= b.x) {
                        if (!b.L) {
                            _ = b.P;
                            break
                        }
    ...
    function qb(t) {
        ...
        Db(t);
        for (var c = o; c.circle && Math.abs(e - c.circle.x) < Hb && Math.abs(r - c.circle.cy) < Hb;) o = c.P, u.unshift(c), Db(c), c = o;
        u.unshift(c), Cb(c);
        for (var f = a; f.circle && Math.abs(e - f.circle.x) < Hb && Math.abs(r - f.circle.cy) < Hb;) a = f.N, u.push(f), Db(f), f = a;
        u.push(f), Cb(f);
        var s, l = u.length;
        for (s = 1; s < l; ++s) f = u[s], c = u[s - 1], mb(f.edge, c.site, f.site, i);
        c = u[0], (f = u[l - 1]).edge = _b(c.site, f.site, null, i), Eb(c), Eb(f)
    }

    function Lb(t) {
        for (var n, e, r, i, o = t[0], a = t[1], u = Bb._; u;) if ((r = Ub(u, a) - o) > Hb) u = u.L; else {
            if (!((i = o - Ob(u, a)) > Hb)) {
    ...
    var Bb, Fb, Yb, Ib, Hb = 1e-6, jb = 1e-12;
    ...
    function Gb(t, n) {
        ...
        for (Ib = [], Fb = new Array(t.length), Bb = new db, Yb = new db; ;) if (i = Ab, o && (!i || o[1] < i.y || o[1] === i.y && o[0] < i.x)) o[0] === e && o[1] === r || (Lb(o), e = o[0], r = o[1]), o = t.pop(); else {
            if (!i) break;
            qb(i.arc)
        }
        if (function () {
            for (var t, n, e, r, i = 0, o = Fb.length; i < o; ++i) if ((t = Fb[i]) && (r = (n = t.halfedges).length)) {
                var a = new Array(r), u = new Array(r);
                for (e = 0; e < r; ++e) a[e] = e, u[e] = Mb(t, Ib[n[e]]);
            ...
            !function (t, n, e, r) {
                for (var i, o = Ib.length; o--;) wb(i = Ib[o], t, n, e, r) && xb(i, t, n, e, r) && (Math.abs(i[0][0] - i[1][0]) > Hb || Math.abs(i[0][1] - i[1][1]) > Hb) || delete Ib[o]
            }(a, u, c, f), function (t, n, e, r) {
                var i, o, a, u, c, f, s, l, h, d, p, v, g = Fb.length, y = !0;
                for (i = 0; i < g; ++i) if (o = Fb[i]) {
                    for (a = o.site, u = (c = o.halfedges).length; u--;) Ib[c[u]] || c.splice(u, 1);
                ...
                for (i = 0; i < g; ++i) (o = Fb[i]) && (o.halfedges.length || delete Fb[i])
            }(a, u, c, f)
        }
    ...
    Gb.prototype = {
        constructor: Gb, polygons: function () {
            var t = this.edges;
            ...
            return this.cells.forEach(function (e, r) {
                if (o = (i = e.halfedges).length) for (var i, o, a, u = e.site, c = -1, f = n[i[o - 1]], s = f.left === u ? f.right : f.left; ++c < o;) a = s, s = (f = n[i[c]]).left === u ? f.right : f.left, a && s && r < a.index && r < s.index && Vb(u, a, s) < 0 && t.push([u.data, a.data, s.data])
            }), t
        }, links: function () {
        ...
        constructor: Zb, scale: function (t) {
    ...
    function Kb(t) {
        for (; !t.__zoom;) if (!(t = t.parentNode)) return Qb;
        return t.__zoom
    }
    ...
    Kb.prototype = Zb.prototype, t.FormatSpecifier = Ba, t.active = function (t, n) {
        ...
        var t = Dy, n = qy, e = xy(0), r = null, i = Ly, o = Uy, a = Oy, u = null;

        function c() {
            var c, f, s = +t.apply(this, arguments), l = +n.apply(this, arguments), h = i.apply(this, arguments) - Py,
                d = o.apply(this, arguments) - Py, p = wy(d - h), v = d > h;
            if (u || (u = c = no()), l < s && (f = l, l = s, s = f), l > Ey) if (p > zy - Ey) u.moveTo(l * Ny(h), l * Sy(h)), u.arc(0, 0, l, h, d, !v), s > Ey && (u.moveTo(s * Ny(d), s * Sy(d)), u.arc(0, 0, s, d, h, v)); else {
                var g, y, _ = h, b = d, m = h, x = d, w = p, M = p, N = a.apply(this, arguments) / 2,
                    T = N > Ey && (r ? +r.apply(this, arguments) : ky(s * s + l * l)),
                    A = Ay(wy(l - s) / 2, +e.apply(this, arguments)), S = A, k = A;
                if (T > Ey) {
                    var E = Ry(T / s * Sy(N)), C = Ry(T / l * Sy(N));
                    (w -= 2 * E) > Ey ? (m += E *= v ? 1 : -1, x -= E) : (w = 0, m = x = (h + d) / 2), (M -= 2 * C) > Ey ? (_ += C *= v ? 1 : -1, b -= C) : (M = 0, _ = b = (h + d) / 2)
                }
                var P = l * Ny(_), z = l * Sy(_), R = s * Ny(x), D = s * Sy(x);
                if (A > Ey) {
                    var q, L = l * Ny(b), U = l * Sy(b), O = s * Ny(m), B = s * Sy(m);
                    if (p < Cy && (q = function (t, n, e, r, i, o, a, u) {
                        var c = e - t, f = r - n, s = a - i, l = u - o, h = l * c - s * f;
                        if (!(h * h < Ey)) return [t + (h = (s * (n - o) - l * (t - i)) / h) * c, n + h * f]
                    }(P, z, O, B, L, U, R, D))) {
                        var F = P - q[0], Y = z - q[1], I = L - q[0], H = U - q[1], j = 1 / Sy(function (t) {
        ...
        var t, n, e = Vc([0, 0]), r = Vc(90), i = Vc(6), o = {
            point: function (e, r) {
        ...
        var t, n, e, r, i, o, a = 1, u = 0, c = 0, f = 1, s = 1, l = Yf, h = null, d = Yf;
        ...
        var t = cl(Nl), n = t.center, e = t.rotate;
        ...
        var t = Gy, n = Xy, e = null, r = xy(0), i = xy(zy), o = xy(0);
        ...
        var o = wh(r), a = wh(i), u = a[0] === o[0], c = a[a.length - 1] === o[o.length - 1], f = [];
        ...
        function a() {
            var a, u = Wi.call(arguments), c = t.apply(this, u), f = n.apply(this, u),
                s = +e.apply(this, (u[0] = c, u)), l = r.apply(this, u) - Vi, h = i.apply(this, u) - Vi, d = s * Ii(l),
                p = s * Hi(l), v = +e.apply(this, (u[0] = f, u)), g = r.apply(this, u) - Vi, y = i.apply(this, u) - Vi;
        ...
        var n, e, r = t.length, i = t.map(fb), o = ab(t), a = 0, u = 0, c = [], f = [];
        ...
        function e(e) {
            ...
            for (i = 0; i < s; ++i) r = e[i], u = l[i] = new Rl(r), null != (c = t(r, i, e)) && (c += "") && (h[f = ih + (u.id = c)] = f in h ? ah : u);
        ...
        var t = fh, n = 1, e = 1, r = null;

        function i(i) {
            var c = function (t) {
                for (var n, e, r, i, o, a = new ph(t, 0), u = [a]; n = u.pop();) if (r = n._.children) for (n.children = new Array(o = r.length), i = o - 1; i >= 0; --i) u.push(e = n.children[i] = new ph(r[i], i)), e.parent = n;
        ...
        function o(n) {
            ...
            n.parent.A = function (n, e, r) {
                if (e) {
                    for (var i, o = n, a = n, u = e, c = o.parent.children[0], f = o.m, s = a.m, l = u.m, h = c.m; u = lh(u), o = sh(o), u && o;) c = sh(c), (a = lh(a)).a = n, (i = u.z + l - o.z - f + t(u._, o._)) > 0 && (hh(dh(u, n, r), n, i), f += i, s += i), l += u.m, f += o.m, h += c.m, s += a.m;
        ...
        var t = _h, n = !1, e = 1, r = 1, i = [0], o = Zl, a = Zl, u = Zl, c = Zl, f = Zl;
        ...
        var n, e, r = nm, i = em, o = am, a = im, u = om, c = [0, 1 / 0], f = [[-1 / 0, -1 / 0], [1 / 0, 1 / 0]],
        ...
        function A() {
            if (r.apply(this, arguments)) {
                ...
                for (Jb(), i = 0; i < c; ++i) a = [a = Ft(this, u, (o = u[i]).identifier), this.__zoom.invert(a), o.identifier], f.touch0 ? f.touch1 || f.touch0[2] === a[2] || (f.touch1 = a, f.taps = 0) : (f.touch0 = a, e = !0, f.taps = 1 + !!n);
        ...
        function S() {
            if (this.__zooming) {
                ...
                for (tm(), n && (n = clearTimeout(n)), u.taps = 0, e = 0; e < s; ++e) i = Ft(this, c, (r = c[e]).identifier), u.touch0 && u.touch0[2] === r.identifier ? u.touch0[0] = i : u.touch1 && u.touch1[2] === r.identifier && (u.touch1[0] = i);
    ...
    },t.zoomIdentity = Qb,t.zoomTransform = Kb,Object.defineProperty(t, "__esModule", {value: !0})
});
