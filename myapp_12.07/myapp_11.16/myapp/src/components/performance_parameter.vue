  ...
  export default {
    ...
    methods: {
      draw_scatter_dataAnalysis() {
        ...
        let colorList = ['rgba(56, 180, 139, .1)','rgba(68, 97, 123, .1)','rgba(191, 120, 58, .1)','rgba(116, 83, 153, .1)']
        let option = {
          tooltip: {
            axisPointer: {
              show: true,
              ...
              itemStyle: {
                normal: {
                  color: function (params) {
                    var colorList = ['#cbdcdf', '#a5bbbf', '#cce8e2', '#ce848f', '#EFBAC0',
              ...
              itemStyle: {
                normal: {
                  ...
                  color: function (params) {
                    ...
                    var colorList = ['#F9F3E1', '#EDE9BF', '#F7E7E0', '#F7DDC0', '#F9BCB2']
                    return colorList[params.dataIndex]
                  }
                }
              },
      ...
      draw_hot() {
       ...
       draw_kuntu(){
        var cities = {
          children:[
            {name: "train_pile", value: [0.16, -0.89], type: "train", advice: []},
            {name: "train_Receiver", value: [0.53, -0.62], type: "train", advice: []},
            {name: "train_digest", value: [0.47, -0.64], type: "train", advice: []},
            {name: "train_getSubId", value: [0.57, -0.81], type: "train", advice: []},
            {name: "test_decode", value: [0.41, -1.52], type: "test", advice: [2.75]},
            {name: "train_getMac", value: [0.61, -0.49], type: "train", advice: []},
            {name: "train_open", value: [0.39, -1.03], type: "train", advice: []},
            {name: "test_getLine", value: [0.73, -0.4], type: "test", advice: [0.2]},
            {name: "train_start", value: [1.03, -0.21], type: "train", advice: []},
            {name: "train_Resources", value: [0.97, -0.14], type: "train", advice: []},
            {name: "test_Setting", value: [0.3, -1.63], type: "test", advice: [0.79]},
            {name: "train_Library", value: [0.31, -0.74], type: "train", advice: []},
            {name: "train_init", value: [0.65, -1.32], type: "train", advice: []},
            {name: "train_TextMessage", value: [0.56, -2.96], type: "train", advice: []},
            {name: "train_register", value: [0.61, -0.53], type: "train", advice: []},
            {name: "test_getMac", value: [0.61, -0.49], type: "test", advice: [2.53]},
            {name: "train_TotalBytes", value: [0.83, -0.49], type: "train", advice: []},
            {name: "test_pile", value: [0.16, -0.89], type: "test", advice: [-0.9]},
            {name: "train_getLine", value: [0.73, -0.39], type: "train", advice: []},
            {name: "test_Receiver", value: [0.53, -0.62], type: "test", advice: [0.98]},
            {name: "train_Setting", value: [0.3, -1.65], type: "train", advice: []},
            {name: "test_digest", value: [0.48, -0.64], type: "test", advice: [-0.15]},
            {name: "test_getSubId", value: [0.57, -0.81], type: "test", advice: [-2.33]},
            {name: "test_Resources", value: [1.05, -0.13], type: "test", advice: [-1.81]},
            {name: "test_Library", value: [0.3, -0.74], type: "test", advice: [1.33]},
            {name: "test_init", value: [0.63, -1.33], type: "test", advice: [-0.91]},
            {name: "test_open", value: [0.39, -1.02], type: "test", advice: [1.36]},
            {name: "train_decode", value: [0.42, -1.51], type: "train", advice: []},
            {name: "test_TextMessage", value: [0.54, -2.95], type: "test", advice: [-2.41]},
            {name: "test_register", value: [0.6, -0.52], type: "test", advice: [-1.13]},
            {name: "test_start", value: [1.04, -0.22], type: "test", advice: [-0.87]},
            {name: "test_TotalBytes", value: [0.84, -0.49], type: "test", advice: [-1.8]}
          ]
        };
        // 航班路线
        var railway =  [
      ...
      d3.select('#draw_bar').selectAll('svg').remove();
        var svg = d3.select("#draw_bar")
          .append('svg')
          // .attr('width', width)
          // .attr('height', height)
        ...
        function drwapie(data) {
          ...
          var path0=d3.svg.arc()
            // .innerRadius(innerRadius)
            .outerRadius(outRadius);

          var path1= d3.svg.arc()
            .outerRadius(outRadius*1.2)

//----------------------内侧特征影响饼图----------------------
          var arcs1= g.selectAll(".arc") //生成和dataset对应的g ,class是arc,数据集有多少个，类有多少个
          ...
          arcs1.on("mouseover",function (d,i) {
            ...
            svg.append("text")
              ...
              .attr("fill", "black")
              .text( data.name+ "正影响:"+ data.value[0]+ "%;负影响:"+ data.value[1] +'%')
          })
...
//----------------------外侧建议值----------------------
          ...
          var path2 = d3.svg.arc()
            .innerRadius(outRadius*(1.2 ))
            .outerRadius(outRadius*1.3 + Math.abs(data.advice[0]/2))

          var arcs2 = g.selectAll(".out_arc")
            .data(pie(data.advice))
            .enter().append("g")
            .attr("class","out_arc")
          ...
          arcs2.append("path")
            ...
            .attr("fill", function(d,i) {
              ...
              else if(d.data >0 && d.data-d.data%1 ==0)  //建议上调权重
              {
                return "#83b4ce"
              }
              else if( d.data-d.data%1 !=0 )             //建议删除该特征
              {
                return "#d27777"
              }
            })
      ...
      draw_scatter() {
        ...
        let color_list = ['#cbdcdf', '#a5bbbf', '#cce8e2', '#ce848f', '#EFBAC0',
          '#F7E7E0', '#F9F3E1', '#EDE9BF',]
        // var data = [
