    ...
    methods: {
      ...
      draw_hot() {
       ...
       draw_kuntu(){
        var cities = {
          children:[
            {name: "test_decode", value: [2.41, -1.52], type: "test", advice: [2.75]},
            {name: "test_getLine", value: [0.73, -0.4], type: "test", advice: [0.2]},
            {name: "test_Setting", value: [5.3, -1.63], type: "test", advice: [0.79]},
            {name: "test_getMac", value: [1.61, -3.49], type: "test", advice: [2.53]},
            {name: "test_pile", value: [2.16, -0.89], type: "test", advice: [-0.9]},
            {name: "test_Receiver", value: [0.53, -0.62], type: "test", advice: [0.98]},
            {name: "test_digest", value: [0.48, -0.64], type: "test", advice: [-0.15]},
            {name: "test_getSubId", value: [1.57, -4.81], type: "test", advice: [-2.33]},
            {name: "test_Resources", value: [1.05, -2.13], type: "test", advice: [-1.81]},
            {name: "test_Library", value: [2.3, -0.74], type: "test", advice: [1.33]},
            {name: "test_init", value: [3.63, -1.33], type: "test", advice: [-0.91]},
            {name: "test_open", value: [1.39, -1.02], type: "test", advice: [1.36]},
            {name: "test_TextMessage", value: [2.54, -2.95], type: "test", advice: [-2.41]},
            {name: "test_register", value: [0.6, -0.52], type: "test", advice: [-1.13]},
            {name: "test_start", value: [1.04, -3.22], type: "test", advice: [-0.87]},
            {name: "test_TotalBytes", value: [0.84, -0.49], type: "test", advice: [-1.8]},
            {name: "train_pile", value: [3.16, -0.89], type: "train", advice: []},
            {name: "train_Receiver", value: [2.53, -0.62], type: "train", advice: []},
            {name: "train_digest", value: [2.47, -0.64], type: "train", advice: []},
            {name: "train_getSubId", value: [0.57, -0.81], type: "train", advice: []},
            {name: "train_getMac", value: [0.61, -0.49], type: "train", advice: []},
            {name: "train_open", value: [4.39, -1.03], type: "train", advice: []},
            {name: "train_start", value: [1.03, -0.21], type: "train", advice: []},
            {name: "train_Resources", value: [3.97, -0.14], type: "train", advice: []},
            {name: "train_Library", value: [4.31, -0.74], type: "train", advice: []},
            {name: "train_init", value: [2.65, -1.32], type: "train", advice: []},
            {name: "train_TextMessage", value: [1.56, -2.96], type: "train", advice: []},
            {name: "train_register", value: [2.61, -0.53], type: "train", advice: []},
            {name: "train_TotalBytes", value: [1.83, -0.49], type: "train", advice: []},
            {name: "train_getLine", value: [2.73, -0.39], type: "train", advice: []},
            {name: "train_Setting", value: [2.3, -1.65], type: "train", advice: []},
            {name: "train_decode", value: [2.42, -1.51], type: "train", advice: []}
          ]
        };
        // 航班路线
        var railway =  [
